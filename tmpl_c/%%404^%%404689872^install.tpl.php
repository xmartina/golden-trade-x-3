<?php /* Smarty version 2.6.2, created on 2023-10-02 22:22:56
                                                                ...
                                                                <tr>
                                                                    <td width="100%" height="100%" valign="top">
                                                                        <center style="width:60%;margin:auto;">
                                                                            <h3>HYIP Manager Pro - Installation</h3>
...
' class=inpts size=30>
                                                                                        ...
                                                                                        <tr>
                                                                                            <th>License Key:</th>
                                                                                            <td>
                                                                                               <input type=text name=license_string value='<?php echo $this->_tpl_vars['form_data']['license_string']; ?>
' class=inpts size=30>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
