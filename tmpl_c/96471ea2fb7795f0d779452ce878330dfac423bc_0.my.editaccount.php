...
<?php
/*%%SmartyHeaderCode:974688493651d6d3b81b9b0_81396182%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '974688493651d6d3b81b9b0_81396182',
  'variables' => 
  array (
    'frm' => 0,
    'user' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_651d6d3b8590f0_21931404',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_651d6d3b8590f0_21931404')) {
function content_651d6d3b8590f0_21931404 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '974688493651d6d3b81b9b0_81396182';
?>
...
" class=inpts size=30></td> </tr> <?php if ($_smarty_tpl->tpl_vars['settings']->value['use_sms_code'] == 1) {?> <tr> <td>Mobile phone:</td> <td><input type=text name=gfst_phone value=<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user']->value['gfst_phone'], ENT_QUOTES, 'UTF-8', true);?>
" class=inpts size=30></td> </tr> <?php }?> <?php if ($_smarty_tpl->tpl_vars['settings']->value['use_user_location']) {?> <tr> <td>Address:</td> <td><input type=text name=address value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user']->value['address'], ENT_QUOTES, 'UTF-8', true);?>
